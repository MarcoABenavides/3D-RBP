...
def sample_generator(file_paths, total_samples=200000, first_segment_length=1003, segment_length=101):
...
if __name__ == "__main__":
    ...
    # Initialize counters
    X, y = [], []
    for X_sample, y_sample in sample_generator(file_paths, total_samples=50000):
        X.append(X_sample)
        y.append(y_sample)
    ...
    results_file = os.path.join(OUTPUT_DIR, "balanced-CNN+3d-data.txt")
